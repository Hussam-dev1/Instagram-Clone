...
class Post_desgin extends StatefulWidget {
  const Post_desgin({super.key});

  @override
  State<Post_desgin> createState() => _Post_desginState();
}

class _Post_desginState extends State<Post_desgin> {
    Map userpost = {};
  getData() async {
    // Get data from DB
